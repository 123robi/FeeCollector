...
public class AppConfig {
	...
	public static final String ULR_CREATE_PAYMENT = "https://rkosir.eu/FeeCollector/paymentsApi/add";
	public static final String URL_GET_QR = "https://rkosir.eu/FeeCollector/paymentsApi/getQrCode";
